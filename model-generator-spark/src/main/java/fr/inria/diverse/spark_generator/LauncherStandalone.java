...
public class LauncherStandalone {
	...
	private static final String E_PACKAGE_CLASS				= "c";
	private static final String E_PACKAGE_CLASS_LONG 		= "package";
	...
	private static class OptionComarator<T extends Option> implements Comparator<T> {
	    private static final String OPTS_ORDER = "eunspdzefg";
