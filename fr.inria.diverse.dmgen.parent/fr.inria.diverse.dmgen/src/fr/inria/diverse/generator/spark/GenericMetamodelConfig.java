...
//		Collections.copy(result , eClasses);
	...
	@Override 
	public ImmutableList <String> getAllClassNames () {
		List<String> content = new LinkedList<String>();
 		metamodelResource.getAllContents().forEachRemaining ( element -> {if (element instanceof EClass) content.add(((EClass)element).getName());});
